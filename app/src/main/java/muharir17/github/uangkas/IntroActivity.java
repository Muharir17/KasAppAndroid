...
public class IntroActivity extends AppIntro {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        addSlide(AppIntroFragment.newInstance("UANGKAS KU", "Belajar Membuat Aplikasi Manajemen Keuangan Dengan Android Studio, PHP & MySQL",
                R.drawable.calc, getResources().getColor(R.color.colorPrimary)));
        addSlide(AppIntroFragment.newInstance("YOUTUBE CHANNEL", "Jangan Lupa Subscribe ^^", R.drawable.coder_uniska, getResources().getColor(R.color.colorPrimary)));
